...
CREATE TABLE ordine (
    ...
    id_venditore INT REFERENCES venditore(id_venditore),
    data_ordine DATE,
    id_spedizioniere INT REFERENCES spedizioniere(id_spedizioniere)
);

CREATE TABLE composizione (
    id_ordine INT REFERENCES ordine(id_ordine),
    id_prodotto INT REFERENCES prodotto(id_prodotto),
    quantita INT);
...
VALUES
   (
      "Condiments", "Sweet 
      and savory sauces, relishes, spreads, 
      and seasonings"
   )
;
INSERT INTO
...
VALUES
   ...
   from
      ...
      VALUES
         (
            "Fuller", "Andrew", "1952 - 02 - 19", "EmpID2.pic", "Andrew received his BTS commercial 
            and a Ph.D. in international marketing 
         from
            the University of Dallas. He is fluent in French 
            and Italian 
            and reads German. He joined the company as a sales representative, was promoted to sales manager 
            and was 
         then
            named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, 
...
VALUES
   (
      "Peacock", "Margaret", "1958 - 09 - 19", "EmpID4.pic", "Margaret holds a BA in English literature 
   from
      Concordia College 
      and an MA 
   from
      the American Institute of Culinary Arts. She was temporarily assigned to the London office before returning to her permanent post in Seattle."
   )
;
INSERT INTO
   venditore (cognome, nome, data, foto, note) 
VALUES
   (
      "Buchanan", "Steven", "1955 - 03 - 04", "EmpID5.pic", "Steven Buchanan graduated 
   from
      St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office 
      and 
   then
   ...
   where
      ...
      VALUES
         (
            ...
            VALUES
               (
                  "King", "Robert", "1960 - 05 - 29", "EmpID7.pic", "Robert King served in the Peace Corps 
               ...
               then
                  ...
                  VALUES
                     (
                        "Callahan", "Laura", "1958 - 01 - 09", "EmpID8.pic", "Laura received a BA in psychology 
                     from
                        the University of Washington. She has also completed a course in business French. She reads 
                        and writes French."
                     )
;
INSERT INTO
...
VALUES
   (
      "Dodsworth", "Anne", "1969 - 07 - 02", "EmpID9.pic", "Anne has a BA degree in English 
   from
      St. Lawrence College. She is fluent in French 
      and German."
   )
;
INSERT INTO
...
INSERT INTO
   composizione (id_ordine, id_prodotto, quantita) 
VALUES
   (
      10248, 11, 12
   )
...
;
INSERT INTO
   ordine(id_ordine, id_cliente, id_venditore, data_ordine, id_spedizioniere) 
VALUES
   (
...
VALUES
   (
      31, "Gorgonzola telefonoino", 14, 4, "12 - 100 g pkgs", 12.5
   )
;
INSERT INTO
   prodotto (id_prodotto, nome, id_fornitore, id_categoria, formato, prezzo) 
...
INSERT INTO
   spedizioniere (id_spedizioniere, nome, telefono) 
VALUES
   (
...
VALUES
   (
      11, "Heli Süßwaren GmbH & amp;
Co. KG", "Petra Winkler", "Tiergartenstraße 5", "Berlin", "10785", "Germany", "(010) 9984510"
   )
;
INSERT INTO
   fornitore (id_fornitore, azienda, referente, indirizzo, citta, cap, nazione, telefono) 
VALUES
   (
      12, "Plutzer Lebensmittelefonogroßmärkte AG", "Martin Bein", "Bogenallee 51", "Frankfurt", "60439", "Germany", "(069) 992755"
   )
;
INSERT INTO
   fornitore (id_fornitore, azienda, referente, indirizzo, citta, cap, nazione, telefono) 
